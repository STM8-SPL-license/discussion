/*-------------------------------------------------------------------------
  STLUX_all-peripherals.h - Register Declarations for STLUX Umbrella Device

  Virtual STLUX device, containing all peripherals to check header
...
#include "../stm8/stlux_stnrg/STLUX_STNRG.h"
