/*-------------------------------------------------------------------------
  STM8A_all-peripherals.h - Register Declarations for STM8A / STM8S Umbrella Device

  Virtual STM8A / STM8S device, containing all peripherals to check header
