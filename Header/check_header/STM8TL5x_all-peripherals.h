/*-------------------------------------------------------------------------
  STM8TL5x_all-peripherals.h - Register Declarations for STM8TL5x Umbrella Device

  Virtual STM8TL5x device, containing all peripherals to check header
...
#include "../stm8/stm8tl5x/STM8TL5x.h"

/*-----------------------------------------------------------------------------
END OF MODULE DEFINITION FOR MULTIPLE INLUSION
-----------------------------------------------------------------------------*/
#endif // STM8TL5X_ALL_H
