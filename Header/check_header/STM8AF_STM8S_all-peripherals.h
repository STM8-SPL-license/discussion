/*-------------------------------------------------------------------------
  STM8AF_STM8S_all-peripherals.h - Register Declarations for STM8AF / STM8S Umbrella Device

  Virtual STM8AF / STM8S device, containing all peripherals to check header
...
-----------------------------------------------------------------------------*/
#ifndef STM8AF_STM8S_ALL_H
#define STM8AF_STM8S_ALL_H
...
#include "../stm8/stm8af_stm8s/STM8AF_STM8S.h"

/*-----------------------------------------------------------------------------
END OF MODULE DEFINITION FOR MULTIPLE INLUSION
-----------------------------------------------------------------------------*/
#endif // STM8AF_STM8S_ALL_H
