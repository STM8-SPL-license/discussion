...
//------------------------
#if defined(PORTA_AddressBase) || defined(PORTB_AddressBase) || defined(PORTD_AddressBase)
...
//------------------------
#if defined(SYSCFG_AddressBase)

  /** @brief struct for System configuration control (SYSCFG) */
  typedef struct {

    /** @brief SYSCFG remap control register (SYSCFG_RMPCR) */
    struct {
      _BITS            : 2;    //   Reserved
  ...
  #define _SYSCFG       _SFR(RMPCR_t,  RMPCR_AddressBase)        ///< System configuration controller struct/bit access
  #define _SYSCFG_RMPCR _SFR(uint8_t,  RMPCR_AddressBase+0x00)   ///< System configuration control register (SYSCFG_RMPCR)
  ...
  /* SYSCFG remap control register (SYSCFG_RMPCR) */
  // reserved [1:0]
  #define _SYSCFG_TIM3_CH1        ((uint8_t) (0x01 << 2))        ///< Timer3 channel 1 mapping [0] (in _SYSCFG_RMPCR)
  #define _SYSCFG_TIM3_CH2        ((uint8_t) (0x01 << 3))        ///< Timer3 channel 2 mapping [0] (in _SYSCFG_RMPCR)
  // reserved [7:4]
...
//------------------------
  ...
  #define _RST_WWDGF              ((uint8_t) (0x01 << 4))        ///< Window Watchdog reset flag [0] (in _RST_SR)
  // reserved [7:5]
...
//------------------------
  ...
  #define _CLK_AWU                ((uint8_t) (0x01 << 6))        ///< clock enable AWU [0] (in _CLK_PCKENR1)
  #define _CLK_PXS                ((uint8_t) (0x01 << 7))        ///< clock enable PXS [0] (in _CLK_PCKENR1)

  /* Peripheral clock gating register 2 (CLK_PCKENR2) */
  #define _CLK_WWDG               ((uint8_t) (0x01 << 0))        ///< clock enable WWDG [0] (in _CLK_PCKENR2)
  // reserved [7:1]
  ...
  #define _CLK_CCOSEL             ((uint8_t) (0x07 << 1))        ///< Configurable clock output selection [2:0] (in _CLK_CCOR)
  ...
  #define _CLK_CCOSLP             ((uint8_t) (0x03 << 4))        ///< Configurable clock output buffer slope [1:0] (in _CLK_CCOR)
  #define _CLK_CCOSLP0            ((uint8_t) (0x01 << 4))        ///< Configurable clock output buffer slope  [0] (in _CLK_CCOR)
  #define _CLK_CCOSLP1            ((uint8_t) (0x01 << 5))        ///< Configurable clock output buffer slope  [1] (in _CLK_CCOR)
  // reserved [7:6]
...
//------------------------
  ...
  typedef struct {
    ...
    /** @brief I2C own address register 1 low byte (I2C_OAR1L) */
    struct {
    ...
    /** @brief I2C own address register 1 high byte (I2C_OAR1H) */
    struct {
      _BITS             : 1;    //   Reserved
  ...
  /* I2C own address register 1 low byte (I2C_OAR1L) */
  #define _I2C_ADD1_0          ((uint8_t) (0x01 << 0))           ///< I2C Interface address 1 [0] (in 10-bit address mode) (in _I2C_OAR1L)
  #define _I2C_ADD1_1          ((uint8_t) (0x01 << 1))           ///< I2C Interface address 1 [1] (in _I2C_OAR1L)
  #define _I2C_ADD1_2          ((uint8_t) (0x01 << 2))           ///< I2C Interface address 1 [2] (in _I2C_OAR1L)
  #define _I2C_ADD1_3          ((uint8_t) (0x01 << 3))           ///< I2C Interface address 1 [3] (in _I2C_OAR1L)
  #define _I2C_ADD1_4          ((uint8_t) (0x01 << 4))           ///< I2C Interface address 1 [4] (in _I2C_OAR1L)
  #define _I2C_ADD1_5          ((uint8_t) (0x01 << 5))           ///< I2C Interface address 1 [5] (in _I2C_OAR1L)
  #define _I2C_ADD1_6          ((uint8_t) (0x01 << 6))           ///< I2C Interface address 1 [6] (in _I2C_OAR1L)
  #define _I2C_ADD1_7          ((uint8_t) (0x01 << 7))           ///< I2C Interface address 1 [7] (in _I2C_OAR1L)

  /* I2C own address register 1 high byte (I2C_OAR1H) */
  // reserved [0]
  #define _I2C_ADD1_8_9        ((uint8_t) (0x03 << 1))           ///< I2C Interface address 1 [9:8] (in 10-bit address mode) (in _I2C_OAR1H)
  #define _I2C_ADD1_8          ((uint8_t) (0x01 << 1))           ///< I2C Interface address 1 [8] (in _I2C_OAR1H)
  #define _I2C_ADD1_9          ((uint8_t) (0x01 << 2))           ///< I2C Interface address 1 [9] (in _I2C_OAR1H)
  // reserved [5:3]
  #define _I2C_ADDCONF         ((uint8_t) (0x01 << 6))           ///< I2C Address mode configuration [0] (in _I2C_OAR1H)
  #define _I2C_ADDMODE         ((uint8_t) (0x01 << 7))           ///< I2C 7-/10-bit addressing mode (Slave mode) [0] (in _I2C_OAR1H)

  /* I2C own address register 2 (I2C_OAR2) */
  #define _I2C_ENDUAL          ((uint8_t) (0x01 << 0))           ///< I2C Dual addressing mode enable (in _I2C_OAR2)
  #define _I2C_ADD2_1          ((uint8_t) (0x01 << 1))           ///< I2C Interface address 2 [1] (in _I2C_OAR2)
  #define _I2C_ADD2_2          ((uint8_t) (0x01 << 2))           ///< I2C Interface address 2 [2] (in _I2C_OAR2)
  #define _I2C_ADD2_3          ((uint8_t) (0x01 << 3))           ///< I2C Interface address 2 [3] (in _I2C_OAR2)
  #define _I2C_ADD2_4          ((uint8_t) (0x01 << 4))           ///< I2C Interface address 2 [4] (in _I2C_OAR2)
  #define _I2C_ADD2_5          ((uint8_t) (0x01 << 5))           ///< I2C Interface address 2 [5] (in _I2C_OAR2)
  #define _I2C_ADD2_6          ((uint8_t) (0x01 << 6))           ///< I2C Interface address 2 [6] (in _I2C_OAR2)
  #define _I2C_ADD2_7          ((uint8_t) (0x01 << 7))           ///< I2C Interface address 2 [7] (in _I2C_OAR2)
...
//------------------------
  ...
  // reserved [2]
  #define _WFE_PXS_EV             ((uint8_t) (0x01 << 3))        ///< Interrupt on proximity sense event [0] (in _WFE_CR1)
...
//------------------------
  ...
  /* Pointer to TIM2 registers */
    ...
    #define _TIM2_CMS               ((uint8_t) (0x03 << 5))        ///< TIM2 Center-aligned Mode Selection [0:1] (in _TIM2_CR1)
    #define _TIM2_CMS0              ((uint8_t) (0x01 << 5))        ///< TIM2 Center-aligned Mode Selection [0] (in _TIM2_CR1)
    #define _TIM2_CMS1              ((uint8_t) (0x01 << 6))        ///< TIM2 Center-aligned Mode Selection [1] (in _TIM2_CR1)
  ...
  /* Pointer to TIM3 registers */
    ...
    #define _TIM3_CMS               ((uint8_t) (0x03 << 5))        ///< TIM3 Center-aligned Mode Selection [0:1] (in _TIM2_CR1)
    #define _TIM3_CMS0              ((uint8_t) (0x01 << 5))        ///< TIM3 Center-aligned Mode Selection [0] (in _TIM2_CR1)
    #define _TIM3_CMS1              ((uint8_t) (0x01 << 6))        ///< TIM3 Center-aligned Mode Selection [1] (in _TIM2_CR1)
...
//------------------------
// Proximity Sense registers (PXS)
//------------------------
#if defined(PXS_AddressBase)

  /** @brief struct for Proximity Sense registers (PXS) */
  typedef struct {

    /** @brief ProxSense Control Register 1 (PXS_CR1) */
    struct {
      _BITS             : 5;    //   Reserved
    ...
    /** @brief ProxSense Control Register 2 (PXS_CR2) */
    struct {
    ...
    /** @brief ProxSense Control Register 3 (PXS_CR3) */
    struct {
    ...
    /** @brief ProxSense Interrupt and Status Register (PXS_ISR) */
    struct {
      _BITS              : 2;    //   Reserved
    ...
    /** @brief ProxSense Clock Control Register 1 (PXS_CKCR1) */
    struct {
    ...
    /** @brief ProxSense Clock Control Register 2 (PXS_CKCR2) */
    struct {
    ...
    /** @brief ProxSense Receiver Enable Register high byte (PXS_RXENRH) */
    struct {
    ...
    /** @brief ProxSense Receiver Enable Register low byte (PXS_RXENRL) */
    struct {
    ...
    /** @brief ProxSense Receiver Control Register 1 high byte (PXS_RXCR1H) */
    struct {
    ...
    /** @brief ProxSense Receiver Control Register 1 low byte (PXS_RXCR1L) */
    struct {
    ...
    /** @brief ProxSense Receiver Control Register 2 high byte (PXS_RXCR2H) */
    struct {
    ...
    /** @brief ProxSense Receiver Control Register 2 low byte (PXS_RXCR2L) */
    struct {
    ...
    /** @brief ProxSense Receiver Control Register 3 high byte (PXS_RXCR3H) */
    struct {
    ...
    /** @brief ProxSense Receiver Control Register 3 low byte (PXS_RXCR3L) */
    struct {
    ...
    /** @brief ProxSense Receiver Inactive State Register high byte (PXS_RXINSRH) */
    struct {
    ...
    /** @brief ProxSense Receiver Inactive State Register low byte (PXS_RXINSRL) */
    struct {
    ...
    /** @brief ProxSense Transmit Enable Register high byte (PXS_TXENRH) */
    struct {
    ...
    /** @brief ProxSense Transmit Enable Register low byte (PXS_TXENRL) */
    struct {
    ...
    /** @brief ProxSense Maximum Counter Value Register high byte (PXS_MAXRH) */
    struct {
      _BITS   MAX        : 8;    ///< maximum allowed value for conversion data [15:8]
    } MAXRH;

    /** @brief ProxSense Maximum Counter Value Register low byte (PXS_MAXRL) */
    struct {
      _BITS   MAX        : 8;    ///< maximum allowed value for conversion data [7:0]
    } MAXRL;

    /** @brief ProxSense Maximum Counter Enable Register high byte (PXS_MAXENRH) */
    struct {
    ...
    /** @brief ProxSense Maximum Counter Enable Register low byte (PXS_MAXENRL) */
    struct {
    ...
    /** @brief ProxSense Receiver Status Register high byte (PXS_RXSRH) */
    struct {
    ...
    /** @brief ProxSense Receiver Status Register low byte (PXS_RXSRL) */
    struct {
    ...
    /** @brief ProxSense Counter Register of Receiver Channel 0 high byte (PXS_RX0CNTRH) */
    struct {
      _BITS   RX0CNT     : 8;    ///< measurement value Receiver Channel 0 [15:8]
    } RX0CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 0 low byte (PXS_RX0CNTRL) */
    struct {
      _BITS   RX0CNT     : 8;    ///< measurement value Receiver Channel 0 [7:0]
    } RX0CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 1 high byte (PXS_RX1CNTRH) */
    struct {
      _BITS   RX1CNT     : 8;    ///< measurement value Receiver Channel 1 [15:8]
    } RX1CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 1 low byte (PXS_RX1CNTRL) */
    struct {
      _BITS   RX1CNT     : 8;    ///< measurement value Receiver Channel 1 [7:0]
    } RX1CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 2 high byte (PXS_RX2CNTRH) */
    struct {
      _BITS   RX2CNT     : 8;    ///< measurement value Receiver Channel 2 [15:8]
    } RX2CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 2 low byte (PXS_RX2CNTRL) */
    struct {
      _BITS   RX2CNT     : 8;    ///< measurement value Receiver Channel 2 [7:0]
    } RX2CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 3 high byte (PXS_RX3CNTRH) */
    struct {
      _BITS   RX3CNT     : 8;    ///< measurement value Receiver Channel 3 [15:8]
    } RX3CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 3 low byte (PXS_RX3CNTRL) */
    struct {
      _BITS   RX3CNT     : 8;    ///< measurement value Receiver Channel 3 [7:0]
    } RX3CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 4 high byte (PXS_RX4CNTRH) */
    struct {
      _BITS   RX4CNT     : 8;    ///< measurement value Receiver Channel 4 [15:8]
    } RX4CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 4 low byte (PXS_RX4CNTRL) */
    struct {
      _BITS   RX4CNT     : 8;    ///< measurement value Receiver Channel 4 [7:0]
    } RX4CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 5 high byte (PXS_RX5CNTRH) */
    struct {
      _BITS   RX5CNT     : 8;    ///< measurement value Receiver Channel 5 [15:8]
    } RX5CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 5 low byte (PXS_RX5CNTRL) */
    struct {
      _BITS   RX5CNT     : 8;    ///< measurement value Receiver Channel 5 [7:0]
    } RX5CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 6 high byte (PXS_RX6CNTRH) */
    struct {
      _BITS   RX6CNT     : 8;    ///< measurement value Receiver Channel 6 [15:8]
    } RX6CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 6 low byte (PXS_RX6CNTRL) */
    struct {
      _BITS   RX6CNT     : 8;    ///< measurement value Receiver Channel 6 [7:0]
    } RX6CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 7 high byte (PXS_RX7CNTRH) */
    struct {
      _BITS   RX7CNT     : 8;    ///< measurement value Receiver Channel 7 [15:8]
    } RX7CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 7 low byte (PXS_RX7CNTRL) */
    struct {
      _BITS   RX7CNT     : 8;    ///< measurement value Receiver Channel 7 [7:0]
    } RX7CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 8 high byte (PXS_RX8CNTRH) */
    struct {
      _BITS   RX8CNT     : 8;    ///< measurement value Receiver Channel 8 [15:8]
    } RX8CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 8 low byte (PXS_RX8CNTRL) */
    struct {
      _BITS   RX8CNT     : 8;    ///< measurement value Receiver Channel 8 [7:0]
    } RX8CNTRL;

    /** @brief ProxSense Counter Register of Receiver Channel 9 high byte (PXS_RX9CNTRH) */
    struct {
      _BITS   RX9CNT     : 8;    ///< measurement value Receiver Channel 9 [15:8]
    } RX9CNTRH;

    /** @brief ProxSense Counter Register of Receiver Channel 9 low byte (PXS_RX9CNTRL) */
    struct {
    ...
    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 0 (PXS_RX0CSSELR) */
    struct {
      _BITS   RX0CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 0 [4:0]
      _BITS              : 3;    //   Reserved
    } RX0CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 1 (PXS_RX1CSSELR) */
    struct {
      _BITS   RX1CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 1 [4:0]
      _BITS              : 3;    //   Reserved
    } RX1CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 2 (PXS_RX2CSSELR) */
    struct {
      _BITS   RX2CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 2 [4:0]
      _BITS              : 3;    //   Reserved
    } RX2CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 3 (PXS_RX3CSSELR) */
    struct {
      _BITS   RX3CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 3 [4:0]
      _BITS              : 3;    //   Reserved
    } RX3CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 4 (PXS_RX4CSSELR) */
    struct {
      _BITS   RX4CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 4 [4:0]
      _BITS              : 3;    //   Reserved
    } RX4CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 5 (PXS_RX5CSSELR) */
    struct {
      _BITS   RX5CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 5 [4:0]
      _BITS              : 3;    //   Reserved
    } RX5CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 6 (PXS_RX6CSSELR) */
    struct {
      _BITS   RX6CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 6 [4:0]
      _BITS              : 3;    //   Reserved
    } RX6CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 7 (PXS_RX7CSSELR) */
    struct {
      _BITS   RX7CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 7 [4:0]
      _BITS              : 3;    //   Reserved
    } RX7CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 8 (PXS_RX8CSSELR) */
    struct {
      _BITS   RX8CSSEL   : 5;    ///< Sampling capacitor size of Receiver Channel 8 [4:0]
      _BITS              : 3;    //   Reserved
    } RX8CSSELR;

    /** @brief ProxSense Receiver Sampling Capacitor Selection for Channel 9 (PXS_RX9CSSELR) */
    struct {
    ...
    /** @brief ProxSense Compensation Capacitor Selection for Channel 0 (PXS_RX0EPCCSELR) */
    struct {
      _BITS   RX0EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 0
    } RX0EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 1 (PXS_RX1EPCCSELR) */
    struct {
      _BITS   RX1EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 1
    } RX1EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 2 (PXS_RX2EPCCSELR) */
    struct {
      _BITS   RX2EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 2
    } RX2EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 3 (PXS_RX3EPCCSELR) */
    struct {
      _BITS   RX3EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 3
    } RX3EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 4 (PXS_RX4EPCCSELR) */
    struct {
      _BITS   RX4EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 4
    } RX4EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 5 (PXS_RX5EPCCSELR) */
    struct {
      _BITS   RX5EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 5
    } RX5EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 6 (PXS_RX6EPCCSELR) */
    struct {
      _BITS   RX6EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 6
    } RX6EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 7 (PXS_RX7EPCCSELR) */
    struct {
      _BITS   RX7EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 7
    } RX7EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 8 (PXS_RX8EPCCSELR) */
    struct {
      _BITS   RX8EPCC    : 8;    ///< Parasitic compensation capacitor of Receiver Channel 8
    } RX8EPCCSELR;

    /** @brief ProxSense Compensation Capacitor Selection for Channel 9 (PXS_RX9EPCCSELR) */
    struct {
  ...
  #define _PXS          _SFR(PXS_t,    PXS_AddressBase)          ///< ProxSense struct/bit access
  ...
  /* ProxSense Control Register 1 (PXS_CR1) */
  // reserved [4:0]
  #define _PXS_LOW_POWER        ((uint8_t) (0x01 << 5))        ///< ProxSense Low power mode [0] (in _PXS_CR1)
  #define _PXS_START            ((uint8_t) (0x01 << 6))        ///< ProxSense Start conversion [0] (in _PXS_CR1)
  #define _PXS_PXSEN            ((uint8_t) (0x01 << 7))        ///< ProxSense enable [0] (in _PXS_CR1)

  /* ProxSense Control Register 2 (PXS_CR2) */
  #define _PXS_SYNCEDGE         ((uint8_t) (0x01 << 0))        ///< ProxSense Synchronization edge selection [0] (in_PXS_CR2)
  #define _PXS_SYNCEN           ((uint8_t) (0x01 << 1))        ///< ProxSense Enable synchronization (SYNC) feature [0] (in_PXS_CR2)
  #define _PXS_RXCOUPLING       ((uint8_t) (0x01 << 2))        ///< ProxSense Reduce coupling between receiver lines [0] (in_PXS_CR2)
  #define _PXS_RXGROUP          ((uint8_t) (0x01 << 3))        ///< ProxSense Rx group selection [0] (in_PXS_CR2)
  // reserved [4]
  #define _PXS_NOISEDETEN       ((uint8_t) (0x01 << 5))        ///< ProxSense Noise detection enable [0] (in_PXS_CR2)
  #define _PXS_FCCITEN          ((uint8_t) (0x01 << 6))        ///< ProxSense First conversion completion interrupt enable [0] (in_PXS_CR2)
  #define _PXS_EOCITEN          ((uint8_t) (0x01 << 7))        ///< ProxSense End of conversion interrupt enable [0] (in_PXS_CR2)

  /* ProxSense Control Register 3 (PXS_CR3) */
  #define _PXS_VTHR             ((uint8_t) (0x0F << 0))        ///< ProxSense Threshold voltage (Vthr) selection [3:0] (in_PXS_CR3)
  #define _PXS_VTHR0            ((uint8_t) (0x01 << 0))        ///< ProxSense Threshold voltage (Vthr) selection [0] (in_PXS_CR3)
  #define _PXS_VTHR1            ((uint8_t) (0x01 << 0))        ///< ProxSense Threshold voltage (Vthr) selection [1] (in_PXS_CR3)
  #define _PXS_VTHR2            ((uint8_t) (0x01 << 0))        ///< ProxSense Threshold voltage (Vthr) selection [2] (in_PXS_CR3)
  #define _PXS_VTHR3            ((uint8_t) (0x01 << 0))        ///< ProxSense Threshold voltage (Vthr) selection [3] (in_PXS_CR3)
  #define _PXS_BIAS             ((uint8_t) (0x03 << 4))        ///< ProxSense Sample and hold strength selection [1:0] (in_PXS_CR3)
  #define _PXS_BIAS0            ((uint8_t) (0x01 << 4))        ///< ProxSense Sample and hold strength selection [0] (in_PXS_CR3)
  #define _PXS_BIAS1            ((uint8_t) (0x01 << 5))        ///< ProxSense Sample and hold strength selection [1] (in_PXS_CR3)
  #define _PXS_STAB             ((uint8_t) (0x03 << 6))        ///< ProxSense Selection for stabilization time after ProxSense power-on [1:0] (in_PXS_CR3)
  #define _PXS_STAB0            ((uint8_t) (0x01 << 6))        ///< ProxSense Selection for stabilization time after ProxSense power-on [0] (in_PXS_CR3)
  #define _PXS_STAB1            ((uint8_t) (0x01 << 7))        ///< ProxSense Selection for stabilization time after ProxSense power-on [1] (in_PXS_CR3)

  /* ProxSense Interrupt and Status Register (PXS_ISR) */
  // reserved [1:0]
  #define _PXS_SYNC_OVRF        ((uint8_t) (0x01 << 2))        ///< ProxSense Synchronization (SYNC) overflow flag [0] (in _PXS_ISR)
  #define _PXS_SYNCPF           ((uint8_t) (0x01 << 3))        ///< ProxSense Synchronization (SYNC) pending flag [0] (in _PXS_ISR)
  #define _PXS_CIPF             ((uint8_t) (0x01 << 4))        ///< ProxSense Conversion in progress flag [0] (in _PXS_ISR)
  #define _PXS_NOISEDETF        ((uint8_t) (0x01 << 5))        ///< ProxSense Noise detection flag [0] (in _PXS_ISR)
  #define _PXS_FCCF             ((uint8_t) (0x01 << 6))        ///< ProxSense First conversion completion flag [0] (in _PXS_ISR)
  #define _PXS_EOCF             ((uint8_t) (0x01 << 7))        ///< ProxSense End of conversion flag [0] (in _PXS_ISR)

  /* ProxSense Clock Control Register 1 (PXS_CKCR1) */
  #define _PXS_INCPHASE         ((uint8_t) (0x01 << 0))        ///< ProxSense Increase length of UP and PASS by 1/2 clock cycle [0] (in _PXS_CKCR1)
  #define _PXS_ANADEAD          ((uint8_t) (0x01 << 1))        ///< ProxSense ensure UP-PASS deadtime using analog delay [0] (in _PXS_CKCR1)
  // reserved [3:2]
  #define _PXS_PRESC            ((uint8_t) (0x07 << 4))        ///< ProxSense Conversion in progress flag [2:0] (in _PXS_CKCR1)
  #define _PXS_PRESC0           ((uint8_t) (0x01 << 4))        ///< ProxSense Conversion in progress flag [0] (in _PXS_CKCR1)
  #define _PXS_PRESC1           ((uint8_t) (0x01 << 5))        ///< ProxSense Conversion in progress flag [1] (in _PXS_CKCR1)
  #define _PXS_PRESC2           ((uint8_t) (0x01 << 6))        ///< ProxSense Conversion in progress flag [2] (in _PXS_CKCR1)
  // reserved [7]

  /* ProxSense Clock Control Register 2 (PXS_CKCR2) */
  #define _PXS_PASSLEN          ((uint8_t) (0x07 << 0))        ///< ProxSense Length of PASS phase [2:0] (in _PXS_CKCR2)
  #define _PXS_PASSLEN0         ((uint8_t) (0x01 << 0))        ///< ProxSense Length of PASS phase [0] (in _PXS_CKCR2)
  #define _PXS_PASSLEN1         ((uint8_t) (0x01 << 1))        ///< ProxSense Length of PASS phase [1] (in _PXS_CKCR2)
  #define _PXS_PASSLEN2         ((uint8_t) (0x01 << 2))        ///< ProxSense Length of PASS phase [2] (in _PXS_CKCR2)
  // reserved [3]
  #define _PXS_UPLEN            ((uint8_t) (0x07 << 4))        ///< ProxSense Length of UP phase [2:0] (in _PXS_CKCR2)
  #define _PXS_UPLEN0           ((uint8_t) (0x01 << 4))        ///< ProxSense Length of UP phase [0] (in _PXS_CKCR2)
  #define _PXS_UPLEN1           ((uint8_t) (0x01 << 5))        ///< ProxSense Length of UP phase [1] (in _PXS_CKCR2)
  #define _PXS_UPLEN2           ((uint8_t) (0x01 << 6))        ///< ProxSense Length of UP phase [2] (in _PXS_CKCR2)
  // reserved [7)

  /* ProxSense Receiver Enable Register high byte (PXS_RXENRH) */
  #define _PXS_RXEN8            ((uint8_t) (0x01 << 0))        ///< ProxSense Enable receiver channel 8 [0] (in _PXS_RXENRH)
  #define _PXS_RXEN9            ((uint8_t) (0x01 << 1))        ///< ProxSense Enable receiver channel 9 [0] (in _PXS_RXENRH)
  // reserved [7:2]

  /* ProxSense Receiver Enable Register low byte (PXS_RXENRL) */
  #define _PXS_RXEN0            ((uint8_t) (0x01 << 0))        ///< ProxSense Enable receiver channel 0 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN1            ((uint8_t) (0x01 << 1))        ///< ProxSense Enable receiver channel 1 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN2            ((uint8_t) (0x01 << 2))        ///< ProxSense Enable receiver channel 2 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN3            ((uint8_t) (0x01 << 3))        ///< ProxSense Enable receiver channel 3 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN4            ((uint8_t) (0x01 << 4))        ///< ProxSense Enable receiver channel 4 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN5            ((uint8_t) (0x01 << 5))        ///< ProxSense Enable receiver channel 5 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN6            ((uint8_t) (0x01 << 6))        ///< ProxSense Enable receiver channel 6 [0] (in _PXS_RXENRL)
  #define _PXS_RXEN7            ((uint8_t) (0x01 << 7))        ///< ProxSense Enable receiver channel 7 [0] (in _PXS_RXENRL)

  /* ProxSense Receiver Control Register 1 high byte (PXS_RXCR1H) */
  #define _PXS_RXCR1_8          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 1 Conversion mode 8 [0] (in _PXS_RXCR1H)
  #define _PXS_RXCR1_9          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 1 Conversion mode 9 [0] (in _PXS_RXCR1H)
  // reserved [7:2]

  /* ProxSense Receiver Control Register 1 low byte (PXS_RXCR1L) */
  #define _PXS_RXCR1_0          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 1 Conversion mode 0 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_1          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 1 Conversion mode 1 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_2          ((uint8_t) (0x01 << 2))        ///< ProxSense Receiver channel 1 Conversion mode 2 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_3          ((uint8_t) (0x01 << 3))        ///< ProxSense Receiver channel 1 Conversion mode 3 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_4          ((uint8_t) (0x01 << 4))        ///< ProxSense Receiver channel 1 Conversion mode 4 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_5          ((uint8_t) (0x01 << 5))        ///< ProxSense Receiver channel 1 Conversion mode 5 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_6          ((uint8_t) (0x01 << 6))        ///< ProxSense Receiver channel 1 Conversion mode 6 [0] (in _PXS_RXCR1L)
  #define _PXS_RXCR1_7          ((uint8_t) (0x01 << 7))        ///< ProxSense Receiver channel 1 Conversion mode 7 [0] (in _PXS_RXCR1L)

  /* ProxSense Receiver Control Register 2 high byte (PXS_RXCR2H) */
  #define _PXS_RXCR2_8          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 2 Conversion mode 8 [0] (in _PXS_RXCR2H)
  #define _PXS_RXCR2_9          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 2 Conversion mode 9 [0] (in _PXS_RXCR2H)
  // reserved [7:2]

  /* ProxSense Receiver Control Register 2 low byte (PXS_RXCR2L) */
  #define _PXS_RXCR2_0          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 2 Conversion mode 0 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_1          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 2 Conversion mode 1 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_2          ((uint8_t) (0x01 << 2))        ///< ProxSense Receiver channel 2 Conversion mode 2 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_3          ((uint8_t) (0x01 << 3))        ///< ProxSense Receiver channel 2 Conversion mode 3 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_4          ((uint8_t) (0x01 << 4))        ///< ProxSense Receiver channel 2 Conversion mode 4 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_5          ((uint8_t) (0x01 << 5))        ///< ProxSense Receiver channel 2 Conversion mode 5 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_6          ((uint8_t) (0x01 << 6))        ///< ProxSense Receiver channel 2 Conversion mode 6 [0] (in _PXS_RXCR2L)
  #define _PXS_RXCR2_7          ((uint8_t) (0x01 << 7))        ///< ProxSense Receiver channel 2 Conversion mode 7 [0] (in _PXS_RXCR2L)

  /* ProxSense Receiver Control Register 3 high byte (PXS_RXCR3H) */
  #define _PXS_RXCR3_8          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 3 Conversion mode 8 [0] (in _PXS_RXCR3H)
  #define _PXS_RXCR3_9          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 3 Conversion mode 9 [0] (in _PXS_RXCR3H)
  // reserved [7:2]

  /* ProxSense Receiver Control Register 3 low byte (PXS_RXCR3L) */
  #define _PXS_RXCR3_0          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 3 Conversion mode 0 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_1          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 3 Conversion mode 1 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_2          ((uint8_t) (0x01 << 2))        ///< ProxSense Receiver channel 3 Conversion mode 2 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_3          ((uint8_t) (0x01 << 3))        ///< ProxSense Receiver channel 3 Conversion mode 3 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_4          ((uint8_t) (0x01 << 4))        ///< ProxSense Receiver channel 3 Conversion mode 4 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_5          ((uint8_t) (0x01 << 5))        ///< ProxSense Receiver channel 3 Conversion mode 5 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_6          ((uint8_t) (0x01 << 6))        ///< ProxSense Receiver channel 3 Conversion mode 6 [0] (in _PXS_RXCR3L)
  #define _PXS_RXCR3_7          ((uint8_t) (0x01 << 7))        ///< ProxSense Receiver channel 3 Conversion mode 7 [0] (in _PXS_RXCR3L)

  /* ProxSense Receiver Inactive State Register high byte (PXS_RXINSRH) */
  #define _PXS_RXINS_8          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 8 inactive state selection [0] (in _PXS_RXINSRH)
  #define _PXS_RXINS_9          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 9 inactive state selection [0] (in _PXS_RXINSRH)
  // reserved [7:2]

  /* ProxSense Receiver Inactive State Register low byte (PXS_RXINSRL) */
  #define _PXS_RXINS_0          ((uint8_t) (0x01 << 0))        ///< ProxSense Receiver channel 0 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_1          ((uint8_t) (0x01 << 1))        ///< ProxSense Receiver channel 1 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_2          ((uint8_t) (0x01 << 2))        ///< ProxSense Receiver channel 2 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_3          ((uint8_t) (0x01 << 3))        ///< ProxSense Receiver channel 3 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_4          ((uint8_t) (0x01 << 4))        ///< ProxSense Receiver channel 4 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_5          ((uint8_t) (0x01 << 5))        ///< ProxSense Receiver channel 5 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_6          ((uint8_t) (0x01 << 6))        ///< ProxSense Receiver channel 6 inactive state selection [0] (in _PXS_RXINSRL)
  #define _PXS_RXINS_7          ((uint8_t) (0x01 << 7))        ///< ProxSense Receiver channel 7 inactive state selection [0] (in _PXS_RXINSRL)

  /* ProxSense Transmit Enable Register high byte (PXS_TXENRH) */
  #define _PXS_TXEN8            ((uint8_t) (0x01 << 0))        ///< ProxSense Transmit output 8 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN9            ((uint8_t) (0x01 << 1))        ///< ProxSense Transmit output 9 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN10           ((uint8_t) (0x01 << 2))        ///< ProxSense Transmit output 10 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN11           ((uint8_t) (0x01 << 3))        ///< ProxSense Transmit output 11 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN12           ((uint8_t) (0x01 << 4))        ///< ProxSense Transmit output 12 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN13           ((uint8_t) (0x01 << 5))        ///< ProxSense Transmit output 13 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN14           ((uint8_t) (0x01 << 6))        ///< ProxSense Transmit output 14 function enable [0] (in _PXS_PXS_TXENRH)
  #define _PXS_TXEN15           ((uint8_t) (0x01 << 7))        ///< ProxSense Transmit output 15 function enable [0] (in _PXS_PXS_TXENRH)

  /* ProxSense Transmit Enable Register low byte (PXS_TXENRL) */
  #define _PXS_TXEN0            ((uint8_t) (0x01 << 0))        ///< ProxSense Transmit output 0 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN1            ((uint8_t) (0x01 << 1))        ///< ProxSense Transmit output 1 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN2            ((uint8_t) (0x01 << 2))        ///< ProxSense Transmit output 2 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN3            ((uint8_t) (0x01 << 3))        ///< ProxSense Transmit output 3 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN4            ((uint8_t) (0x01 << 4))        ///< ProxSense Transmit output 4 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN5            ((uint8_t) (0x01 << 5))        ///< ProxSense Transmit output 5 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN6            ((uint8_t) (0x01 << 6))        ///< ProxSense Transmit output 6 function enable [0] (in _PXS_TXENRL)
  #define _PXS_TXEN7            ((uint8_t) (0x01 << 7))        ///< ProxSense Transmit output 7 function enable [0] (in _PXS_TXENRL)

  /* ProxSense Maximum Counter Enable Register high byte (PXS_MAXENRH) */
  #define _PXS_MAXEN8           ((uint8_t) (0x01 << 0))        ///< ProxSense enabled counter limit for Receive channel 8 [0] (in _PXS_MAXENRH)
  #define _PXS_MAXEN9           ((uint8_t) (0x01 << 1))        ///< ProxSense enabled counter limit for Receive channel 9 [0] (in _PXS_MAXENRH)
  // reserved [7:2]

  /* ProxSense Maximum Counter Enable Register low byte (PXS_MAXENRL) */
  #define _PXS_MAXEN0           ((uint8_t) (0x01 << 0))        ///< ProxSense enabled counter limit for Receive channel 0 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN1           ((uint8_t) (0x01 << 1))        ///< ProxSense enabled counter limit for Receive channel 1 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN2           ((uint8_t) (0x01 << 2))        ///< ProxSense enabled counter limit for Receive channel 2 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN3           ((uint8_t) (0x01 << 3))        ///< ProxSense enabled counter limit for Receive channel 3 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN4           ((uint8_t) (0x01 << 4))        ///< ProxSense enabled counter limit for Receive channel 4 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN5           ((uint8_t) (0x01 << 5))        ///< ProxSense enabled counter limit for Receive channel 5 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN6           ((uint8_t) (0x01 << 6))        ///< ProxSense enabled counter limit for Receive channel 6 [0] (in _PXS_MAXENRL)
  #define _PXS_MAXEN7           ((uint8_t) (0x01 << 7))        ///< ProxSense enabled counter limit for Receive channel 7 [0] (in _PXS_MAXENRL)

  /* ProxSense Receiver Status Register high byte (PXS_RXSRH) */
  #define _PXS_VALID8           ((uint8_t) (0x01 << 0))        ///< ProxSense Valid bit for conversion data for receiver channel 8 is valid [0] (in _PXS_RXSRH)
  #define _PXS_VALID9           ((uint8_t) (0x01 << 1))        ///< ProxSense Valid bit for conversion data for receiver channel 9 is valid [0] (in _PXS_RXSRH)
  // reserved [7:2]

  /* ProxSense Receiver Status Register low byte (PXS_RXSRL) */
  #define _PXS_VALID0           ((uint8_t) (0x01 << 0))        ///< ProxSense Valid bit for conversion data for receiver channel 0 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID1           ((uint8_t) (0x01 << 1))        ///< ProxSense Valid bit for conversion data for receiver channel 1 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID2           ((uint8_t) (0x01 << 2))        ///< ProxSense Valid bit for conversion data for receiver channel 2 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID3           ((uint8_t) (0x01 << 3))        ///< ProxSense Valid bit for conversion data for receiver channel 3 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID4           ((uint8_t) (0x01 << 4))        ///< ProxSense Valid bit for conversion data for receiver channel 4 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID5           ((uint8_t) (0x01 << 5))        ///< ProxSense Valid bit for conversion data for receiver channel 5 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID6           ((uint8_t) (0x01 << 6))        ///< ProxSense Valid bit for conversion data for receiver channel 6 is valid [0] (in _PXS_RXSRL)
  #define _PXS_VALID7           ((uint8_t) (0x01 << 7))        ///< ProxSense Valid bit for conversion data for receiver channel 7 is valid [0] (in _PXS_RXSRL)

  /* ProxSense Receiver Sampling Capacitor Selection for Channel N (0..9) (PXS_RXnCSSELR) */
  #define _PXS_RXnCSSEL         ((uint8_t) (0x1F << 0))        ///< ProxSense Sampling capacitor size of Receiver Channel 0 [4:0] (in _PXS_RXnCSSELR)
  #define _PXS_RXnCSSEL0        ((uint8_t) (0x01 << 0))        ///< ProxSense Sampling capacitor size of Receiver Channel 0 [0] (in _PXS_RXnCSSELR)
  #define _PXS_RXnCSSEL1        ((uint8_t) (0x01 << 1))        ///< ProxSense Sampling capacitor size of Receiver Channel 0 [1] (in _PXS_RXnCSSELR)
  #define _PXS_RXnCSSEL2        ((uint8_t) (0x01 << 2))        ///< ProxSense Sampling capacitor size of Receiver Channel 0 [2] (in _PXS_RXnCSSELR)
  #define _PXS_RXnCSSEL3        ((uint8_t) (0x01 << 3))        ///< ProxSense Sampling capacitor size of Receiver Channel 0 [3] (in _PXS_RXnCSSELR)
  #define _PXS_RXnCSSEL4        ((uint8_t) (0x01 << 4))        ///< ProxSense Sampling capacitor size of Receiver Channel 0 [4] (in _PXS_RXnCSSELR)
  // reserved [7:5]
