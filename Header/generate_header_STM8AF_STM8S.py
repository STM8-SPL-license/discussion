...
parser.add_argument('-p', '--peripherals', type=str,   help='Peripherals Excel',  required=False, default='Peripherals_STM8AF_STM8S.xlsx')
...
hdlr = logging.FileHandler('./export_stm8af_stm8s.log')
