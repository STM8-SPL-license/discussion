/*-------------------------------------------------------------------------
  STM8S007C8.h - Register Declarations for STM STM8S007C8

  Mainstream Value line 8-bit MCU with 64 Kbytes Flash, 24 MHz CPU, integrated EEPROM
