/*-------------------------------------------------------------------------
  STM8S105S6.h - Register Declarations for STM STM8S105S6

  Mainstream Access line 8-bit MCU with 32 Kbytes Flash, 24 MHz CPU, integrated EEPROM
