/*-------------------------------------------------------------------------
  STM8S208RB.h - Register Declarations for STM STM8S208RB

  Mainstream Performance line 8-bit MCU with 128 Kbyes Flash, 24 MHz CPU, integrated EEPROM
