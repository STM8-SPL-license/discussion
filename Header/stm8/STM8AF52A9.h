/*-------------------------------------------------------------------------
  STM8AF52A9.h - Register Declarations for STM STM8AF52A9

  Automotive 8-bit MCU with 128 Kbytes Flash, LIN, CAN, 24 MHz CPU, integrated EEPROM
...
// define device
#if !defined(STM8AF52A9)
  #define STM8AF52A9
#endif

// define device line
#if !defined(STM8AF52Ax)
  #define STM8AF52Ax
#endif
