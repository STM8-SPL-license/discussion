...
/*-------------------------------------------------------------------------
  STM8AF6246.h - Register Declarations for STM STM8AF6246

  Automotive 8-bit MCU with 16 Kbytes Flash, LIN, 16 MHz CPU, integrated EEPROM
...
#if !defined(STM8AF6246)
  #define STM8AF6246
#endif
#if !defined(STM8AF624x)
  #define STM8AF624x
#endif
