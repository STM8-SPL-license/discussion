/*-------------------------------------------------------------------------
  STM8AF5268.h - Register Declarations for STM STM8AF5268

  Automotive 8-bit MCU with 32 Kbytes Flash, LIN, CAN, 24 MHz CPU, integrated EEPROM
...
#if !defined(STM8AF5268)
  #define STM8AF5268
#endif
#if !defined(STM8AF526x)
  #define STM8AF526x
#endif
